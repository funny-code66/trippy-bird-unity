...
public class ERC721Enumerable
{
    ...
    public static async Task<int> tokenOfOwnerByIndex(string _chain, string _network, string _contract, string _account, string _tokenId, string _rpc="")
    {
